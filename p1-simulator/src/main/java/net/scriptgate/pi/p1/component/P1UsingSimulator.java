...
public class P1UsingSimulator implements P1, ApplicationRunner {
    ...
    public static final Logger LOG = LoggerFactory.getLogger(P1UsingSimulator.class);
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        LOG.warn("WARNING: This is FAKE data that should only be used for testing purposes.");
